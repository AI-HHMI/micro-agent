...
Usage:
    pixi run explore
    # or
    python -m micro_agent.app [--port 9000] [--ng-port 9001]
"""
...
from micro_agent.loader import CropSample, UnifiedLoader
from micro_agent.registry import Registry

log = logging.getLogger("micro_agent.app")
...
<title>Micro-Agent Explorer</title>
<style>
...
def serve(port: int = 9000, ng_port: int = 9001) -> None:
    """Start the Micro-Agent web explorer."""
    ...
    print(f"\n  Micro-Agent Explorer:  http://{hostname}:{port}/")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Micro-Agent web explorer")
